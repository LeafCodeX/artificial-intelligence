...
class QAgent(Agent):
    ...
    def init_q_table(self, initial_q_value=0.):
        ...
        # przechowywanie oczekiwanych nagród (każda akcja-stan)
    ...
    def update_action_policy(self) -> None:
        ...
        # balansowania pomiędzy eksploracją, a eksploatacją.
    ...
    def choose_action(self, state: State) -> Action:
        ...
        # wybór losowej akcji (eksploracja), a  prawdopodobieństwem o najwyższym oczekiwanym zwrocie (Q_table - eksploatacja).
    ...
    def learn(self, state: State, action: Action, reward: float, new_state: State, done: bool) -> None:
        ...
        # dla danego stanu i akcji kieruje się obecną nagrodą oraz przewidywaną przyszłą nagrodą (z współczynnikiem uczenia)
